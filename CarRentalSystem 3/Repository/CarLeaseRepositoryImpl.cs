  ...
  public class CarLeaseRepositoryImpl : ICarLeaseRepository
    {
        ...
        public void AddCar(Vehicle vehicle)
        {
            try
            {
                ...
                cmd.CommandText = "INSERT INTO Vehicle VALUES (@vechicleID,@make, @model, @year, @dailyRate, @status, @passengerCapacity, @engineCapacity)";
                cmd.Connection = sqlconnection;
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@vechicleID", vehicle.VehicleID);
        ...
        public void RemoveCar(int vehicleID)
        {
            try
            {
                ...
                {
                    Console.WriteLine("Error.Vehicle not deleted");
                }                       
            }
            catch (Exception ex)
            {
        ...
        public void RecordPayment(Lease lease, double amount)
        {
            ...
            {
                Console.WriteLine("Error. Payment not recorded.");
            }
        }
    }
}
